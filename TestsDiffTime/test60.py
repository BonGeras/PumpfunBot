...
def gen_log_filename():
    ...
    directory = os.path.join(base_dir, "TestRunsResults/60SecondsOneFile")
    if not os.path.exists(directory):
        os.makedirs(directory)
    return os.path.join(directory, f"TS60-{dt}.log")
...
async def handle_token_creation(websocket, balance1, balance2, balance3, balance4, balance5):
    ...
    while True:
        try:
            ...
            # Сбор данных в течение 60 секунд для всех стратегий
